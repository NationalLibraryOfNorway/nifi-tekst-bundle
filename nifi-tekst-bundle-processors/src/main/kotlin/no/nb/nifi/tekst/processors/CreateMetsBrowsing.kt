...
class CreateMetsBrowsing : AbstractProcessor() {
    ...
    companion object {
        ...
        val ALTO_FOLDER: PropertyDescriptor = PropertyDescriptor.Builder()
            ...
            .description("Path to ALTO XML files. Can be relative to the Object Folder (e.g., representations/access/metadata/other/ocr) or absolute.")
            .expressionLanguageSupported(ExpressionLanguageScope.FLOWFILE_ATTRIBUTES)
            .required(true)
            .defaultValue("representations/access/metadata/other/ocr")
            .addValidator(StandardValidators.NON_BLANK_VALIDATOR)
            .build()
        ...
        val IMAGE_FOLDER: PropertyDescriptor = PropertyDescriptor.Builder()
            ...
            .description("Path to JP2 image files. Can be relative to the Object Folder (e.g., representations/access/data) or absolute.")
            .expressionLanguageSupported(ExpressionLanguageScope.FLOWFILE_ATTRIBUTES)
            .required(true)
            .defaultValue("representations/access/data")
            .addValidator(StandardValidators.NON_BLANK_VALIDATOR)
            .build()
        ...
        val JHOVE_FOLDER: PropertyDescriptor = PropertyDescriptor.Builder()
            ...
            .description("Path to JHOVE XML metadata files. Can be relative to the Object Folder (e.g., representations/access/metadata/technical/jhove) or absolute.")
            .expressionLanguageSupported(ExpressionLanguageScope.FLOWFILE_ATTRIBUTES)
            .required(true)
            .defaultValue("representations/access/metadata/technical/jhove")
            .addValidator(StandardValidators.NON_BLANK_VALIDATOR)
            .build()
